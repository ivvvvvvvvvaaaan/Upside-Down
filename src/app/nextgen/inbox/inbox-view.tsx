...
import { LayoutGrid, FileText, Film } from 'lucide-react'
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-1.5">
                        {(kind === 'folder' || kind === 'collection' || kind === 'smart-collection') && <LayoutGrid className="w-3.5 h-3.5 text-foreground-dim flex-shrink-0" />}
