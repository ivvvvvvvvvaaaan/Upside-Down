...
export function InboxView() {
  ...
  const handleRowClick = useCallback((entry: GrantView) => {
    ...
    if (isMobile) {
      const href = getSharedResourceHref({
        resourceId: entry.resourceId,
        resourceType: entry.resourceType as AccessEntryKind,
  ...
  return (
    <div className="flex h-full">
      {/* Entry list */}
      <div className="w-full md:w-1/3 md:min-w-[280px] flex flex-col overflow-hidden">
