...
export function SmartCollectionDetailView({ collectionId }: SmartCollectionDetailViewProps) {
  ...
  const { getCollection, getChildren, updateCollection, deleteCollection, allAssets, assetsLoading } = useSmartCollections()
  ...
  return (
    <AppLayout>
      <div className="h-full flex">
        ...
        {/* Side panel - only for user-editable collections */}
        {collection && !isAutoGeneratedChild && (
          <SmartCollectionSidePanel
