...
export function SmartCollectionDetailView({ collectionId }: SmartCollectionDetailViewProps) {
  ...
  const canManageCollection = !!collection && (!activePersona || collection.createdBy === activePersona.email)
    ...
    <div className="h-full flex">
      ...
      {selectedChildCollection && (
        <SmartCollectionSidePanel
          ...
          onUpdate={canManageCollection ? handleUpdateCollection : undefined}
      ...
      {collection && (
        <SmartCollectionSidePanel
          ...
          onClose={closePanel}
          onUpdate={canManageCollection ? handleUpdateCollection : undefined}
          onDelete={isAutoGeneratedChild || !canManageCollection ? undefined : handleDeleteCollection}
