...
export function ArtDesignView({ initialCollections }: ArtDesignViewProps) {
  ...
  // Filter options for art department
  const filterOptions = [
    { id: 'type', label: 'Type' },
                ...
                <div ref={headerRef} className="flex flex-col gap-3">
                  <PageHeader
                    ...
                    description={viewMode === 'assets'
                      ? "Browse all art department assets"
                      : "Browse art department collections by type or character"
                    }
                  />
                ...
                {viewMode === 'assets' && (
                  <>
                    {isPreloading ? (
                      ...
                      <EmptyState
                        title="No assets found"
                        message="No assets available in the art department"
                      />
                    )}
                  </>
                )}
