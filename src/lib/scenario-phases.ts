...
export const PHASES: Phase[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        instruction: 'Share the "Framestore Deliveries" folder with the Framestore team',
        personaId: 'vfx-coordinator',
        checkpoint: {
          type: 'grant-set',
  ...
  },
  {
    ...
    steps: [
      ...
      {
        id: 'p2-browse-folder',
        instruction: 'Open the "Framestore Deliveries" folder and browse existing deliverables',
        personaId: 'vendor-framestore',
  ...
  },
  {
    ...
    steps: [
      {
        id: 'p3-browse-vendor',
        instruction: 'Open the "Framestore Deliveries" folder and review the vendor deliveries',
        personaId: 'vfx-supervisor',
        checkpoint: { type: 'visit-resource', basePath: '/nextgen/workspace', resourceId: 'ws-vfx-to-framestore' },
      },
      {
