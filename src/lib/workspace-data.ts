...
const artDepartmentFiles: WorkspaceFileNode[] = [
  ...
  { id: 'ws-art-loose-4', name: 'mood_board_draft.jpg', type: 'file', extension: 'jpg', size: 5242880, modifiedAt: '2026-02-12' },
  {
    ...
    children: [
      ...
      { id: 'ws-art-concept-demogorgon', name: 'concept_art_demogorgon.jpg', type: 'file', extension: 'jpg', size: 8388608, modifiedAt: '2026-02-11', modifiedBy: 'psharma@netflix.com' },
      { id: 'ws-art-concept-ud-env', name: 'upside_down_environment_concept.jpg', type: 'file', extension: 'jpg', size: 12582912, modifiedAt: '2026-02-10', modifiedBy: 'psharma@netflix.com' },
      { id: 'ws-art-concept-creature', name: 'demogorgon_creature_design.jpg', type: 'file', extension: 'jpg', size: 9437184, modifiedAt: '2026-02-09', modifiedBy: 'psharma@netflix.com' },
      { id: 'ws-art-concept-lab', name: 'hawkins_lab_interior_concept.jpg', type: 'file', extension: 'jpg', size: 7340032, modifiedAt: '2026-02-08', modifiedBy: 'psharma@netflix.com' },
    ],
  },
  { id: 'ws-art-loose-5', name: 'color_test_001.png', type: 'file', extension: 'png', size: 3145728, modifiedAt: '2026-02-11' },
  {
    ...
    children: [
      ...
      { id: 'ws-art-sb-animatic', name: 'season_3_animatic_v2.mov', type: 'file', extension: 'mov', size: 524288000, modifiedAt: '2026-02-09' },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'ws-art-char-billy', name: 'costume_designs_billy.png', type: 'file', extension: 'png', size: 6291456, modifiedAt: '2026-02-09', modifiedBy: 'psharma@netflix.com' },
      { id: 'ws-art-char-hopper', name: 'hopper_uniform_design.png', type: 'file', extension: 'png', size: 5242880, modifiedAt: '2026-02-08' },
      { id: 'ws-art-char-eleven', name: 'eleven_hospital_gown_design.png', type: 'file', extension: 'png', size: 4194304, modifiedAt: '2026-02-07' },
    ],
  },
  {
    ...
    children: [
      ...
      { id: 'ws-art-env-byers', name: 'byers_house_floor_plan.pdf', type: 'file', extension: 'pdf', size: 8388608, modifiedAt: '2026-02-08' },
      { id: 'ws-art-env-starcourt', name: 'starcourt_mall_blueprints.pdf', type: 'file', extension: 'pdf', size: 10485760, modifiedAt: '2026-02-07' },
    ],
  },
  { id: 'ws-art-loose-6', name: 'TODO_cleanup_assets.md', type: 'file', extension: 'md', size: 512, modifiedAt: '2026-02-09' },
  {
    ...
    children: [
      ...
      { id: 'ws-art-props-walkie', name: 'walkie_talkie_prop_design.png', type: 'file', extension: 'png', size: 4194304, modifiedAt: '2026-02-07' },
      { id: 'ws-art-props-lights', name: 'christmas_lights_props.png', type: 'file', extension: 'png', size: 3145728, modifiedAt: '2026-02-06' },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'ws-art-ref-80s', name: '1980s_hawkins_reference_photos.zip', type: 'file', extension: 'zip', size: 104857600, modifiedAt: '2026-02-05' },
      { id: 'ws-art-ref-arcade', name: 'arcade_reference_collection.zip', type: 'file', extension: 'zip', size: 78643200, modifiedAt: '2026-02-04' },
    ],
  },
...
const vfxFiles: WorkspaceFileNode[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        modifiedAt: '2026-02-11',
        children: [
          { id: 'ws-vfx-comp-eleven', name: 'eleven_powers_comp_v4.nk', type: 'file', extension: 'nk', size: 52428800, modifiedAt: '2026-02-11', modifiedBy: 'mtorres@netflix.com' },
          { id: 'ws-vfx-comp-lab', name: 'hawkins_lab_destruction_comp.nk', type: 'file', extension: 'nk', size: 67108864, modifiedAt: '2026-02-10', modifiedBy: 'schen@netflix.com' },
          { id: 'ws-vfx-comp-nosebleed', name: 'eleven_nosebleed_effect.nk', type: 'file', extension: 'nk', size: 31457280, modifiedAt: '2026-02-09', modifiedBy: 'mtorres@netflix.com' },
        ],
      },
    ],
  },
    ...
    children: [
      {
        ...
        children: [
          ...
          { id: 'ws-vfx-3d-demogorgon', name: 'demogorgon_rig_v3.mb', type: 'file', extension: 'mb', size: 157286400, modifiedAt: '2026-02-10' },
          { id: 'ws-vfx-3d-demo-tex', name: 'demogorgon_texture_maps.zip', type: 'file', extension: 'zip', size: 104857600, modifiedAt: '2026-02-09' },
          { id: 'ws-vfx-3d-mindflayer', name: 'mind_flayer_model_v5.mb', type: 'file', extension: 'mb', size: 209715200, modifiedAt: '2026-02-08' },
          { id: 'ws-vfx-3d-demodogs', name: 'demodogs_pack_rig.mb', type: 'file', extension: 'mb', size: 125829120, modifiedAt: '2026-02-07' },
          { id: 'ws-vfx-3d-starcourt', name: 'starcourt_mall_destruction.mb', type: 'file', extension: 'mb', size: 178257920, modifiedAt: '2026-02-06' },
        ],
      },
      {
      ...
      },
      {
        ...
        modifiedAt: '2026-02-08',
        children: [
          { id: 'ws-vfx-matte-ud', name: 'upside_down_matte_v3.psd', type: 'file', extension: 'psd', size: 157286400, modifiedAt: '2026-02-08' },
          { id: 'ws-vfx-matte-skyline', name: 'hawkins_skyline_matte.psd', type: 'file', extension: 'psd', size: 125829120, modifiedAt: '2026-02-07' },
        ],
      },
    ],
  },
  {
    ...
    children: [
      ...
      { id: 'ws-vfx-elem-fog', name: 'upside_down_fog_sim.hip', type: 'file', extension: 'hip', size: 209715200, modifiedAt: '2026-02-06' },
      { id: 'ws-vfx-elem-portal', name: 'portal_particles_v2.hip', type: 'file', extension: 'hip', size: 104857600, modifiedAt: '2026-02-05' },
      { id: 'ws-vfx-elem-preview', name: 'vfx_preview_upside_down.mov', type: 'file', extension: 'mov', size: 314572800, modifiedAt: '2026-02-04' },
...
const cameraFiles: WorkspaceFileNode[] = [
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { id: 'ws-cam-broll-town', name: 'hawkins_town_square_broll.mov', type: 'file', extension: 'mov', size: 943718400, modifiedAt: '2026-02-11' },
          { id: 'ws-cam-broll-forest', name: 'forest_atmosphere_broll.mov', type: 'file', extension: 'mov', size: 838860800, modifiedAt: '2026-02-11' },
          { id: 'ws-cam-aerial-dawn', name: 'hawkins_aerial_dawn.mov', type: 'file', extension: 'mov', size: 1073741824, modifiedAt: '2026-02-10' },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'ws-cam-sel-billy', name: 'billy_closeup_confrontation.mov', type: 'file', extension: 'mov', size: 943718400, modifiedAt: '2026-02-11' },
      { id: 'ws-cam-sel-eleven', name: 'eleven_powers_awakening.mov', type: 'file', extension: 'mov', size: 1073741824, modifiedAt: '2026-02-10' },
      { id: 'ws-cam-sel-portal', name: 'upside_down_portal_opening.mov', type: 'file', extension: 'mov', size: 1342177280, modifiedAt: '2026-02-09' },
    ],
  },
  {
    id: 'ws-cam-luts',
...
const editorialFiles: WorkspaceFileNode[] = [
  {
    ...
    zone: 'managed',
    children: [
      { id: 'ws-edit-cut-1', name: 'EP301_Directors_Cut_v4.prproj', type: 'file', extension: 'prproj', size: 52428800, modifiedAt: '2026-02-14', modifiedBy: 'msantos@netflix.com' },
      { id: 'ws-edit-cut-2', name: 'EP301_Assembly_v2.prproj', type: 'file', extension: 'prproj', size: 41943040, modifiedAt: '2026-02-12', modifiedBy: 'msantos@netflix.com' },
      { id: 'ws-edit-cut-3', name: 'EP302_Rough_Cut_v1.prproj', type: 'file', extension: 'prproj', size: 36700160, modifiedAt: '2026-02-10', modifiedBy: 'lkim@netflix.com' },
      { id: 'ws-edit-cut-locked', name: 'locked_cut_episode_07.mov', type: 'file', extension: 'mov', size: 8589934592, modifiedAt: '2026-02-09', modifiedBy: 'msantos@netflix.com' },
      { id: 'ws-edit-cut-rough1', name: 'ep01_rough_cut_v3.mov', type: 'file', extension: 'mov', size: 6442450944, modifiedAt: '2026-02-08', modifiedBy: 'msantos@netflix.com' },
      { id: 'ws-edit-cut-rough2', name: 'ep02_rough_cut_v1.mov', type: 'file', extension: 'mov', size: 7516192768, modifiedAt: '2026-02-07' },
      { id: 'ws-edit-cut-assembly', name: 'ep01_assembly_v1.mov', type: 'file', extension: 'mov', size: 9663676416, modifiedAt: '2026-02-06' },
      { id: 'ws-edit-cut-fine', name: 'ep01_fine_cut_v2.mov', type: 'file', extension: 'mov', size: 7516192768, modifiedAt: '2026-02-05' },
    ],
  },
  {
    id: 'ws-edit-exports',
    ...
    modifiedAt: '2026-02-13',
    children: [
      { id: 'ws-edit-exp-1', name: 'EP301_DC_v4_ProRes.mov', type: 'file', extension: 'mov', size: 8589934592, modifiedAt: '2026-02-13', modifiedBy: 'lkim@netflix.com' },
      { id: 'ws-edit-exp-2', name: 'EP301_DC_v4_H264_Review.mp4', type: 'file', extension: 'mp4', size: 524288000, modifiedAt: '2026-02-13', modifiedBy: 'msantos@netflix.com' },
...
const audioFiles: WorkspaceFileNode[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'ws-audio-sfx-growl', name: 'demogorgon_growl_sfx.wav', type: 'file', extension: 'wav', size: 15728640, modifiedAt: '2026-02-09' },
      { id: 'ws-audio-sfx-portal', name: 'portal_opening_sfx.wav', type: 'file', extension: 'wav', size: 20971520, modifiedAt: '2026-02-08' },
      { id: 'ws-audio-sfx-powers', name: 'eleven_powers_sfx.wav', type: 'file', extension: 'wav', size: 10485760, modifiedAt: '2026-02-07' },
      { id: 'ws-audio-sfx-ambience', name: 'upside_down_ambience.wav', type: 'file', extension: 'wav', size: 157286400, modifiedAt: '2026-02-06' },
      { id: 'ws-audio-sfx-atmos', name: 'hawkins_night_atmos.wav', type: 'file', extension: 'wav', size: 209715200, modifiedAt: '2026-02-05' },
    ],
  },
  {
    id: 'ws-audio-music',
  ...
  },
  {
    ...
    children: [
      { id: 'ws-audio-adr-eleven', name: 'eleven_adr_session_01.wav', type: 'file', extension: 'wav', size: 209715200, modifiedAt: '2026-02-04' },
    ],
  },
  {
    id: 'ws-audio-mix',
